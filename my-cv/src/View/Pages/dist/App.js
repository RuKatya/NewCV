...
function App() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].post("/sendUserData", { email: email, name: name, message: message }).then(function (res) {
    ...
    return (react_1["default"].createElement("div", { className: "App" },
        react_1["default"].createElement(EnterPage_1["default"], null)));
}
exports["default"] = App;
