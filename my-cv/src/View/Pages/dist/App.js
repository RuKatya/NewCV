...
var EnterPage_1 = require("../Components/EnterPage");
...
function App() {
    ...
    var _a = react_1.useState(3), top = _a[0], setTop = _a[1];
    var _b = react_1.useState(3), left = _b[0], setLeft = _b[1];
    var _c = react_1.useState(3), right = _c[0], setRight = _c[1];
    var _d = react_1.useState(3), bottom = _d[0], setBottom = _d[1];
    var _e = react_1.useState(pacmanElement === null || pacmanElement === void 0 ? void 0 : pacmanElement.getBoundingClientRect()), pacmanPlace = _e[0], setPacmanPlace = _e[1];
    // let pacmanPosition =
    // const [moveFlag, setMoveFlag] = useState(0);
    react_1.useEffect(function () {
        var changeScroll = function (e) {
            // console.log(e);
    ...
    return (React.createElement("div", { className: "App" },
        pacman,
        move,
        React.createElement(EnterPage_1["default"], null),
